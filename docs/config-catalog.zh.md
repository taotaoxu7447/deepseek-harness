...
来源： [`packages/remote/remote-tunnels/src/index.ts:71`](../packages/remote/remote-tunnels/src/index.ts)
...
需要：`tools` · `vision` · `fs` · `systemPrompt`
...
来源：[`packages/vision/tool-vision/src/index.ts:34`](../packages/vision/tool-vision/src/index.ts)
...
来源：[`packages/vision/vision/src/index.ts:36`](../packages/vision/vision/src/index.ts)
...
来源： [`packages/vision/vision-qwen/src/index.ts:109`](../packages/vision/vision-qwen/src/index.ts)
...
来源：[`packages/bundle/web-app/src/index.ts:95`](../packages/bundle/web-app/src/index.ts)
