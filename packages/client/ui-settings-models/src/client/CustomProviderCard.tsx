 ...
 *
 * There is deliberately no provider-scoped reasoning-effort control: effort
 ...
 * reject. Each model row of the editor's model list declares the levels it
 * accepts instead, and the composer's model picker offers each model its own
 * levels.
 */
