...
export const en = {
  ...
  modelReasoningEffortsPlaceholder: 'off, high=high, max=max — empty inherits the catalog; false disables',
  ...
  modelEffortPreset: 'Preset…',
  'effortPreset.deepseek-v4': 'DeepSeek V4 (off/high/max)',
  'effortPreset.openai-grades': 'OpenAI grades (minimal–high)',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelReasoningEffortsPlaceholder: 'off, high=high, max=max —— 留空继承目录；false 表示不支持',
  modelReasoningEffortsInvalid: '请使用已知档位（off、minimal、low、medium、high、xhigh、max）；除 off 外每个档位都要有线上值。',
  modelEffortPreset: '预设…',
  'effortPreset.deepseek-v4': 'DeepSeek V4（off/high/max）',
  'effortPreset.openai-grades': 'OpenAI 档位（minimal–high）',
