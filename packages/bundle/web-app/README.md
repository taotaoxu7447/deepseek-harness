...
- **A recordless deployment never reports stale** — without `.dsh-build/client-build-environment.json` the health route answers `builtAt: null`; the staleness signal exists for checkout-built servers, and an installed copy is never nagged.
