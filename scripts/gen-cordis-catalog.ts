...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  VisionDescribeRequest: 'vision.md',
  VisionDescription: 'vision.md',
  VisionProvider: 'vision.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  RemoteDeviceView: 'tunnel device wire view is owned by packages/remote/remote-tunnels/README.md',
